  ...
  return (
    <View style={{flex:1,backgroundColor:'#d5f0f5',padding:10}}>
        ...
        <View style={{flexDirection:'row',padding:4,marginTop:10}}>
            ...
            <View style={{flex:6}}> 
                <Text style={{color:'black',fontSize:16,fontFamily:"Dosis-Regular"}}>Good Afternoon</Text>
                <Text style={{color:'#1d86f0',fontSize:22,fontFamily:"Dosis-Bold"}}>PRASAD INDIKA</Text>
            </View>
        ...
        <View style={{flex:1,flexDirection:'column',backgroundColor:'white',borderRadius:7,padding:4,marginTop:15}}>
            <View style={{}}> 
                ...
                <View style={{marginTop:10,display:'flex',flexDirection:'row',justifyContent:'space-evenly'}}>
                    <TouchableOpacity>
                        <View style={{width:100,paddingVertical:6,borderRadius:20,alignItems:'center',backgroundColor:'#16a0f0'}}>
                            <Text style={{color:'white',fontSize:16,fontFamily:'Dosis-SemiBold'}}>New</Text>
                        </View>
                    </TouchableOpacity>
                    <TouchableOpacity>
